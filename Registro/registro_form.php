...
<body>
    ...
    <form method="post" action="index.php">
        ...
        <br>
        <img class="user1" src="img/User.webp" alt="" height="45px" width="80px">
        <div class="usertwo">
           <img src="img/user2.jpg" height="40px" width="40px" style="margin-right: 10px;">
            <input type="text" name="nombre" required placeholder="Nombre de Usuario" style="width: 200px; height: 37px;">
        </div>
        <br>
        <div class="CorreoElec">
            <img src="img/email.jpg" alt="" height="40px" width="40px" style="margin-right: 10px;">
            <input type="email" required name="correo" placeholder="Correo eletronico" style="width: 200px; height: 37px;">
        </div>
        <br>
        <div class="Password">
            <img src="img/asterisco.jpg" alt="" height="40px" width="40px" style="margin-right: 10px;">
